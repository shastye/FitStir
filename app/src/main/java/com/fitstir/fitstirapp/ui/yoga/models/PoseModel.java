...
public class PoseModel {
    ...
    private String category_name,difficulty_level,english_name,sanskrit_name,
            translation_name,pose_description,pose_benefits,url_png,url_Vid;
    ...
    public PoseModel(String category_name, String difficulty_level, String english_name, String sanskrit_name,
    ...
    public void setPose_description(String pose_description) {
        this.pose_description = pose_description;
    }

    public void setPose_benefits(String pose_benefits) {
        this.pose_benefits = pose_benefits;
    }
